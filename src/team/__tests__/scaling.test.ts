...
import { isScalingEnabled, scaleUp as scaleUpRaw, scaleDown } from '../scaling.js';
...
async function initTeamState(
  ...
  await installTeamTestAuthority(args[4]);
  return initTeamStateRaw(...args);
}

async function scaleUp(
  ...args: Parameters<typeof scaleUpRaw>
): ReturnType<typeof scaleUpRaw> {
  await hardenTeamTestAuthority(args[4]);
  return scaleUpRaw(...args);
}
